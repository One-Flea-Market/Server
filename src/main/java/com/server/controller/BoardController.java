...
public class BoardController {
    ...
    public ResponseEntity<?> boardView(@PathVariable int page) {
        ...
        // 서비스에서 게시글 목록을 가져옴
        List<BoardDTO> boardList = boardService.getBoard(offset);
    ...
    /* 게시글 작성 */
    @PostMapping("/new")
    public ResponseEntity<?> boardWrite(@RequestBody BoardRequestDTO requestDTO, HttpServletRequest request) {
        Map<String, Object> response = new HashMap<>();
    ...
    @GetMapping("/{id}")
    public ResponseEntity<?> getBoardById(@PathVariable int id, BoardDTO dto, HttpServletRequest request) {
        log.info("{}", id);
        Map<String, Object> response = new HashMap<>();
            ...
            for (Cookie cookie : cookies) {
                if (cookie.getName().equals("JSESSIONID")) {
                    ...
                    for (BoardDTO listDto : productList) {
                        ...
                        responseList.add(boardMap);
                        response.put("BoardList", responseList);
                    }
                }
            }
        } else {
    ...
    public ResponseEntity<?> getBoardBySearch(@PathVariable String search, @PathVariable int page) {
        ...
        // 서비스에서 상품 목록을 가져옴
        List<BoardDTO> boardList = boardService.getBoardBySearch(search, offset);
        ...
        if (cookies != null) {
            for (Cookie cookie : cookies) {
                if (cookie.getName().equals("JSESSIONID")) {
                    ...
                    // 댓글 리스트를 반환
                    response.put("CommentList", reqDtoBoard);
                }
            }
        } else {
            log.info("실패");
    ...
    public ResponseEntity<?> commentBoardWrite(@PathVariable int id, @RequestBody BoardCommentDTO dto, HttpServletRequest request) {
        log.info("게시글 id : {}", id);
        Map<String, Object> response = new HashMap<>();
    ...
    public ResponseEntity<?> modifyBoardComment(@PathVariable int id, @PathVariable int commentId, @RequestBody Map<String, Object> map,
                                                BoardCommentDTO dto, HttpServletRequest request) {
        log.info("게시글 id : {}", id);
        Map<String, Object> response = new HashMap<>();
