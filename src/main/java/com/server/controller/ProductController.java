...
public class ProductController {
    ...
    public ResponseEntity<?> productView(@PathVariable int page) {
        ...
        // 서비스에서 상품 목록을 가져옴
        List<ProductDTO> productList = productService.getProductWithOffset(offset);
    ...
    /* 상품 상세 */
    @GetMapping("/{id}")
    public ResponseEntity<?> getProductById(@PathVariable int id, ProductDTO dto, HttpServletRequest request) {
            ...
            for (Cookie cookie : cookies) {
                if (cookie.getName().equals("JSESSIONID")) {
                    ...
                    for (ProductDTO listDto : productList) {
                        ...
                        responseList.add(productMap);
                        response.put("Product", responseList);
                    }
                }
            }
        } else {
    ...
    public ResponseEntity<?> modifyProduct(@PathVariable int id, ProductRequestDTO requestDTO, HttpServletRequest request) {
        log.info("{}", id);
        Map<String, Object> response = new HashMap<>();
    ...
    public ResponseEntity<?> updateLikeStatus(@PathVariable int id, @RequestBody LikeDTO dto, HttpServletRequest request) {
    ...
    public ResponseEntity<?> getProductBySearch(@PathVariable String search, @PathVariable int page) {
        ...
        log.info("검색된 상품 개수 ( count ) : {}", count);

        // 서비스에서 상품 목록을 가져옴
        List<ProductDTO> productList = productService.getProductBySearch(search, offset);
    ...
    public ResponseEntity<?> commentOnProduct(@PathVariable int id, HttpServletRequest request) {
        log.info("상품 id : {}", id);
        Map<String, Object> response = new HashMap<>();
        ...
        if (cookies != null) {
            for (Cookie cookie : cookies) {
                if (cookie.getName().equals("JSESSIONID")) {
                    ...
                    response.put("CommentList", reqDtoProduct);
                }
            }
        } else {
            log.info("실패");
    ...
    public ResponseEntity<?> commentProductWrite(@PathVariable int id, @RequestBody ProductCommentDTO dto, HttpServletRequest request) {
        log.info("상품 id : {}", id);
        Map<String, Object> response = new HashMap<>();
    ...
    public ResponseEntity<?> modifyProductComment(@PathVariable int id, @PathVariable int commentId, @RequestBody Map<String, Object> map,
                                                ProductCommentDTO dto, HttpServletRequest request) {
        log.info("상품 id : {}", id);
        Map<String, Object> response = new HashMap<>();
